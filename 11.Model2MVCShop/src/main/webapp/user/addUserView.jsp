...
<body style="background-image : url(../images/welcome.jpg); background-size : cover;">
	...
	<div class="container" style="background-color:Whitesmoke;">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userId" name="userId" placeholder="중복확인했니?"  readonly>
		       <span id="helpBlock" class="help-block">
		      	<strong class="text-danger">입력 전 중복확인 부터..</strong>
		      </span>
		    </div>
		    <div class="col-sm-3">
		      <button type="button" class="btn btn-default"><strong>중복확인</strong></button>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" class="btn btn-danger btn-lg"  >&nbsp;가 &nbsp;&nbsp;입&nbsp;</button>
			  <a class="btn btn-danger btn-lg" href="#" role="button">&nbsp;취&nbsp;&nbsp;소&nbsp;</a>
		    </div>
		  </div>
		</form>
		<!-- form Start /////////////////////////////////////-->
